        ...
        <div class="col-lg-7 mb-3 d-flex align-items-stretch border-white">
          <div class="card">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <h5 class="card-title">           
                <div class="air3-icon md" data-v-a5b8af64="">
              ...
              <p class="card-text mb-4">Register and browse professionals, explore projects, or even book a consultation.</p>
              <h5 class="card-title">
                <div class="air3-icon md" data-v-a5b8af64="">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true" viewBox="0 0 24 24" role="img">
                ...
                Post a job and hire top talent.</h5>
              <p class="card-text mb-4">Finding talent doesn’t have to be a chore. Post a job or we can search for you!</p>
              <h5 class="card-title">
                ...
                Work with the best—without breaking the bank.</h5>
              <p class="card-text mb-4">Upwork makes it affordable to up your work and take advantage of low transaction rates.</p>
              <div class="d-flex mt-5">
                <a href="#" class="d-md-inline-block btn btn-primary text-white mt-auto align-self-start d-md-none d-sm-none d-lg-block">Sign Up for free</a>
                <a href="#" class=" btn text-dark mt-auto align-self-start border-success mx-auto">Learn how to hire</a>
              </div>
            </div>
          </div>
        </div>
