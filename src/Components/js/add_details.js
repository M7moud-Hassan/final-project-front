  ...
  education.style.display='block';
   ...
   document.getElementById('checkbox_iswork').addEventListener('change',function(){
    ...
    document.getElementById('addEducation').addEventListener('click',function(){
      ...
      education.style.display = "none";
      edcontent.innerHTML+='<div id="peducation" class=" col-3 card text-white bg-info mb-3 contentMa" style="max-width: 18rem;"><div class="card-header">'+school+'</div><div class="card-body"><h5 class="card-title">'+degree+'</h5><p class="card-text">'+study+'</p><p class="card-text">description</p></div></div>';
    }
    });
