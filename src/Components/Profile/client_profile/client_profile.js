                                ...
                                </div>
                                {
                                    <div class="row ">
                                        <div class="">
                                            ...
                                            <div class=" mt-3">
                                                <h2><a href="#" class="text-center text-success">{jobsDetails.title}</a></h2>
                                                <p class="text-muted paraDetails">
                                                    post at {
                                                                    ...
                                                                    if (ind == 0) {
                                                                        return (
                                                                            <div class="carousel-item active">
                                                                                <img src={"http://localhost:8000" + ele} class="d-block w-100" alt="..." />
                                                                            </div>
                                                                        )
                                                                    } else {
                                                                        return (
                                                                            <div class="carousel-item ">
                                                                                <img className=' d-block w-100' src={"http://localhost:8000" + ele} alt="..." />
                                                                            </div>
                                                                        )
                                                                    }
                                                                })) : (<div></div>)
                                            ...
                                            <hr />
                                            <div>
                                                <p className='helpText'>{jobsDetails.description}</p>
                                                ...
                                                <div class="col" className='abskill'>
                                                    ...
                                                    <div>
                                                        {jobsDetails.skills ? (jobsDetails.skills.map(ele => {
                                                            return <span className="badge bg-secondary rounded-pill m-1">{ele}</span>
                                                ...
                                                <div class="col" style={
                                                    ...
                                                    <div className='row mt-2'>
                                                        {jobsDetails.proposals ? jobsDetails.proposals.map(ele => {
                                                            return (
                                                                <div class="chip col-md-4 ms-4 mt-4">
