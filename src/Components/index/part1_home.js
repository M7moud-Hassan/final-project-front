          ...
          <section className="mt-5 mb-5 shadow-sm">
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-5 mb-3 d-flex align-items-stretch">
                  <div className="card">
                ...
                <div className="col-md-7 mb-3 d-flex">
                  <div className="card">
                    <h2 className="mt-5 ms-3">Up your work game, it’s free.</h2>
                    <div className="card-body d-flex flex-column">
                      ...
                      <p className="card-text mb-4">Register and browse professionals, explore projects, or even book a consultation.</p>
                      <h5 className="card-title">
                        <div className="air3-icon md" data-v-a5b8af64="">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden="true" viewBox="0 0 24 24" role="img">
                      ...
                      <p className="card-text mb-4">Finding talent doesn’t have to be a chore. Post a job or we can search for you!</p>
                      <h5 className="card-title">
                      ...
                      <p className="card-text mb-4">Upwork makes it affordable to up your work and take advantage of low transaction rates.</p>
