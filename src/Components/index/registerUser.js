        ...
        <div>
          ...
          <nav className="navbar navbar-expand-lg navbar-light bg-white">
            <div className="container">
              ...
              }><img className='imgLogo' src="images/inLogo.png " alt="Logo"></img></NavLink>
              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                ...
                <div className="navbar-nav ms-auto">
                  <div className="text-center">
                    ...
                    <NavLink className={'text-center text-success mt-3 fontEditsHalf ms-3'} onClick={
                      () => {
                        window.location='/registration_freelancer'
                      }
                    }><button className='btn btn-success '>Sign up as a Freelancer</button></NavLink>
                    <span className='ms-3 BBold'>or</span>
                                        <NavLink className={'text-center text-success mt-3 fontEditsHalf ms-3'} onClick={
                      () => {
                        window.location='/login'
                      }
                    }><button className='btn  btn-outline-success'>Login</button></NavLink>
                  </div>
                </div>
                      ...
                      <div className="card-body p-4 p-md-5">
                        ...
                        <form method='post' onSubmit={this.handleSubmit} className="needs-validation" noValidate>
                            ...
                            <div className="col-md-6 mb-4">
                              <div className="form-outline position-relative">
                                <input type="text" id="lastName" placeholder="Last Name" required
                                  className="form-control  rounded-pill ms-md-3" value={this.state.lastName} onChange={this.handleLastNameChange} />
                                <div className="invalid-feedback text-center">
                          ...
                          <div className="form-check mt-4">
                            ...
                            <label className="form-check-label fixedFonts" htmlFor="send_emails">
