        ...
        <div className="row card1"  >
                <div className="row g-0">
                    <div className="col-md-8" >
                        <div className="card-body cardHome1">
                            ...
                            <ul className="text-light">
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                        height="16" fill="currentColor" className="bi bi-calendar-fill" viewBox="0 0 16 16">
                                        <path
                                            d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V5h16V4H0V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5z" />
                                    </svg>
                                    <span> Control your workflow: hire, classNameify and pay your
                                        talent</span>
                                </li>

                                <li>
                                    <svg width="16"
                                        height="16" fill="currentColor" className="bi bi-headset" viewBox="0 0 16 16">
                                        <path
                    ...
                    <div className="col-md-4">
                        <img src=".\images\hxwn-enterprise-image@2x.webp"
                            className="img-fluid rounded-start imgHome1" alt="..."/>
                    </div>
                </div>
        ...
        <div className="row mt-4 section4">
            <div className="card mb-3 rounded">
                <div className="row g-0">
                    ...
                    <div className="col-md-6 section4-2">
            ...
            <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src=".\images\pexels-harrison-haines-3536424.jpg" className="d-block w-100" alt="..."/>
                    ...
                    <div className="carousel-item">
                        <img src=".\images\pexels-movidagrafica-barcelona-1474993.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
                    ...
                    <div className="carousel-item">
                        <img src=".\images\pexels-pixabay-259984.jpg" className="d-block w-100" alt="..."/>
                        <div className="carousel-caption d-none d-md-block">
