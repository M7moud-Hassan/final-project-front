        ...
        <footer className="text-center text-lg-start text-white rounded " id="footer">
            <div className="container p-4 pb-0 mt-5">
                ...
                <section className="mb-4 text-center mt-5">
                    ...
                    <button className="btn btn-outline-light btn-floating m-1 iconz disabled" href="#!" role="button">
                    ...
                    <button className="btn btn-outline-light btn-floating m-1 iconz disabled"  role="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div className="text-center p-3 copyRight text-center " id="Copyright">
